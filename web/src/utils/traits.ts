...
export const TRAIT_REGISTRY: Record<string, TraitMeta> = {
  ...
  meihuo_raozhen: trait('meihuo_raozhen', '魅惑扰阵', 'bonus', '仅在主动进攻时使敌方全军步兵、骑兵防御降低 10%。', '主动进攻战斗前'),
  ...
  rende: trait('rende', '仁德天下', 'special', '进攻、守城或作为援军战斗结束后必定触发，按本场真实阵亡复活 50% 士兵，单场最多复活 10000。', '进攻/防守/增援战斗结束后'),
  renzhu_shouhu: trait('renzhu_shouhu', '仁主守护', 'bonus', '进攻、守城或作为援军战斗结束后返还本场真实阵亡的 10%，单场最多返还 10000，与其他归队效果累计不超过本场阵亡。', '进攻/防守/增援战斗结束后'),
  shuiyan_qijun: trait('shuiyan_qijun', '水淹七军', 'special', '战斗前有 35% 概率使敌方 35% 兵力形成真实伤亡。', '战斗前'),
  wusheng_pojun: trait('wusheng_pojun', '武圣破军', 'bonus', '仅在主动进攻时使所带全军攻击提升 20%。', '主动进攻战斗前'),
  zhenhe_quanjun: trait('zhenhe_quanjun', '震慑全军', 'special', '战斗前有 50% 概率让敌方 50% 兵力仅本场不参战，战后保留。', '战斗前'),
  wanren_nuhou: trait('wanren_nuhou', '万人怒吼', 'bonus', '仅在主动进攻时使所带步兵攻击提升 20%。', '主动进攻战斗前'),
  qimen_dunjia: trait('qimen_dunjia', '奇门遁甲', 'special', '战斗前必定让敌方 25% 兵力仅本场不参战，战后保留。', '战斗前'),
  wolong_mouzhi: trait('wolong_mouzhi', '卧龙谋制', 'bonus', '战斗结算后必定拦截敌方 1 项后续特性；没有可拦截特性时实际压制数为 0。', '战斗结算后'),
  longdan_jiuyuan: trait('longdan_jiuyuan', '龙胆救援', 'special', '仅在防守或增援时有 35% 概率降低 20% 最终实际损失，主动进攻无效。', '防守/增援战斗结算后'),
  ...
  baibu_chuanyang: trait('baibu_chuanyang', '百步穿杨', 'special', '仅在主动进攻时有 35% 概率使敌方全军步兵、骑兵防御降低 20%。', '主动进攻战斗前'),
  laodang_yizhuang: trait('laodang_yizhuang', '老当益壮', 'bonus', '进攻、守城或作为援军时，战斗结算后按敌方各兵种战前人数尝试追加 10% 损失，实际扣兵以战报为准。', '战斗结算后'),
  qibing_raohou: trait('qibing_raohou', '奇兵绕后', 'special', '仅在主动进攻时有 35% 概率降低敌军 20% 步兵、骑兵防御。', '主动进攻战斗前'),
