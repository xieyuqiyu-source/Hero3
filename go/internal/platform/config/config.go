// Package config 负责读取 Hero3 服务运行配置。
package config
...
func Load() Config {
	...
	return Config{
		...
		RunStartupMigrations: getBoolEnv("HERO3_RUN_STARTUP_MIGRATIONS", !strings.EqualFold(environment, "production")),
