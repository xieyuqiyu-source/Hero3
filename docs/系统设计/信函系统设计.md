# <span style="color:#2563eb">Hero3 信函系统开发设计文档</span>

最后更新：2026-06-11
## <span style="color:#8b5cf6">1. 模块定位</span>
...
## <span style="color:#8b5cf6">2. 设计目标</span>
...
## <span style="color:#8b5cf6">3. 核心原则</span>
...
## <span style="color:#8b5cf6">4. 信函类型设计</span>
...
## <span style="color:#8b5cf6">5. 数据模型</span>
...
## <span style="color:#8b5cf6">6. 后端接口设计</span>
...
## <span style="color:#8b5cf6">7. Repository 设计</span>
...
## <span style="color:#8b5cf6">8. Service 设计</span>
...
## <span style="color:#8b5cf6">9. Web 玩家端设计</span>
...
## <span style="color:#8b5cf6">10. Admin 设计</span>
...
## <span style="color:#8b5cf6">11. 玩家互发设计</span>
...
## <span style="color:#8b5cf6">12. 附件领取设计</span>
...
## <span style="color:#8b5cf6">13. 过期策略</span>
...
## <span style="color:#8b5cf6">14. 红点与未读数</span>
...
## <span style="color:#8b5cf6">15. OpenAPI 要求</span>

开发信函接口时必须同步维护：

```text
docs/接口文档/openapi/paths/mail.yaml
docs/接口文档/openapi/schemas/mail.yaml
...
## <span style="color:#8b5cf6">16. 第一阶段开发拆分</span>
...
- 更新 OpenAPI。
- 重要变更写入当天 `memory/`，必要时同步本文档和接口文档。
- 运行 `go test ./...`。
- 运行 `web npm run build`。
- 运行 `admin npm run build`。

## <span style="color:#8b5cf6">17. 第一阶段不做的内容</span>
...
## <span style="color:#8b5cf6">18. 验收标准</span>
...
## <span style="color:#8b5cf6">19. 风险点</span>
...
## <span style="color:#8b5cf6">20. 推荐第一版结论</span>
