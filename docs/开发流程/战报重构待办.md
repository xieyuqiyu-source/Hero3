# <span style="color:#16a34a">战报系统重构待办</span>

最后更新：2026-05-24
文档状态：deprecated

## <span style="color:#16a34a">背景</span>

当前战报存在 `state_json` 的 `recentBattleReports` 数组里，需要改为独立数据库表存储。

## <span style="color:#16a34a">待改动项</span>
...
## <span style="color:#16a34a">执行顺序</span>
...
## <span style="color:#16a34a">不变的部分</span>
...
## <span style="color:#16a34a">10. 防守方信息 25% 阈值</span>
